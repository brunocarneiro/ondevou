...
<body>
<tag:notloggedin>
    <a href="signin"><img src="res/midia/Sign-in-with-Twitter-darker.png"/></a>
</tag:notloggedin>
<tag:loggedin>
    <h1>Welcome ${twitter.screenName} (${twitter.id})</h1>

    <form action="http://localhost:8080/site/post" method="post">
        <textarea cols="80" rows="2" name="text"></textarea>
        <input type="submit" name="post" value="update"/>
    </form>
    <a href="http://localhost:8080/site/logout">logout</a>
</tag:loggedin>
</body>
</html>
