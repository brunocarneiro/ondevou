...
public class FacebookServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		fetchSingleObject(facebookClient, out);
		
		fetchMultipleObjet(facebookClient, out);
		
		fetchConnections(facebookClient, out);
		
		searching(facebookClient, out);

		executeFQLQueries(facebookClient, out);

		metadataManyCalls(facebookClient, out);
		
		passingParameters(facebookClient, out);
		
		selectingSpecificFields(facebookClient, out);
		
		//fetchInsights(facebookClient, out);
		
		//dataAsJSONObject(facebookClient, out);

		//publishingSimpleMessage(facebookClient, out);
		
		//publishingImage(facebookClient, out);		
		
		//publishingCheckIn(facebookClient, out);
		
		//deleteObject(facebookClient, out);		
		...
		//batchRequest(facebookClient, out);
		
		//includingBinaryAttachment(facebookClient);
	...
	private void includingBinaryAttachment(FacebookClient facebookClient) {
	...
	private void batchRequest(FacebookClient facebookClient, PrintWriter out) {
	...
	private void deleteObject(FacebookClient facebookClient, PrintWriter out) {
		Boolean deleted = facebookClient.deleteObject("some object ID");
		out.println("Deleted object? " + deleted);
		out.println("<br/>");
	}

	private void publishingCheckIn(FacebookClient facebookClient, PrintWriter out) {
	...
	private void publishingImage(FacebookClient facebookClient, PrintWriter out) {
	...
	private void publishingSimpleMessage(FacebookClient facebookClient, PrintWriter out) {
	...
	private void dataAsJSONObject(FacebookClient facebookClient, PrintWriter out) {
	...
	private void selectingSpecificFields(FacebookClient facebookClient,
			PrintWriter out) {
	...
	private void passingParameters(FacebookClient facebookClient,
			PrintWriter out) {
	...
	private void metadataManyCalls(FacebookClient facebookClient, PrintWriter out) {
	...
	private void executeFQLQueries(FacebookClient facebookClient, PrintWriter out) {
		//FQL
		String query = "SELECT uid, name FROM user WHERE uid=220439 or uid=7901103";
	...
	private void fetchInsights(FacebookClient facebookClient, PrintWriter out) {
	...
	private void searching(FacebookClient facebookClient, PrintWriter out) {
	...
	private void fetchConnections(FacebookClient facebookClient, PrintWriter out) {
	...
	private void fetchMultipleObjet(FacebookClient facebookClient, PrintWriter out) {
	...
	private void fetchSingleObject(FacebookClient facebookClient,
			PrintWriter out) {
